 ...
 * @since 3.0.0
 */
class Settings_JavaScript extends Settings_Base {
	...
	protected function init(): void {
		$this->page_slug  = 'brag-book-gallery-javascript';
			...
			<div class="brag-book-gallery-notice brag-book-gallery-notice-warning">
				<p>
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=brag-book-gallery-mode' ) ); ?>">
						<?php esc_html_e( 'Switch to JavaScript Mode', 'brag-book-gallery' ); ?>
					</a>
				</p>
			</div>
			<?php
	...
	private function save(): void {
		if ( ! $this->save_settings( 'brag_book_gallery_javascript_settings', 'brag_book_gallery_javascript_nonce' ) ) {
			return;
		}
		...
		$this->add_notice( __( 'JavaScript mode settings saved successfully.', 'brag-book-gallery' ) );
