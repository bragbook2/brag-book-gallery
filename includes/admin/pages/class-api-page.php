 ...
 * @since 3.0.0
 */
class API_Page extends Settings_Base {
	...
	public function handle_check_slug(): void {
		...
		// Get current gallery slug from option
		...
		// Check if this slug is the current gallery slug
		$is_gallery_slug = ( $slug === $current_gallery_slug );
	...
	public function handle_generate_page(): void {
		...
		try {
			...
			// Update gallery page slug
			// Update the gallery page slug option
			$update_result = update_option( 'brag_book_gallery_page_slug', $slug );
