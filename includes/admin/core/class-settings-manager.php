...
use BRAGBookGallery\Includes\Admin\Core\Menu;
use BRAGBookGallery\Includes\Admin\Core\Settings_Base;

// Trait_Cache_Handler removed per user request
...
class Settings_Manager {
	...
	public function add_menu_pages(): void {
		...
		// Communications submenu (handled by Menu class - legacy code removed)
