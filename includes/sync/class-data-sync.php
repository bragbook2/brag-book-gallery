...
class Data_Sync {
	...
	public function __construct() {
		try {
			...
			try {
				...
				brag_book_log( 'BRAG book Gallery Sync: Could not initialize database for registry: ' . $e->getMessage() );
			}
		} catch ( Exception $e ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Constructor failed with exception: ' . $e->getMessage() );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Exception trace: ' . $e->getTraceAsString() );
			throw $e;
		} catch ( Error $e ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Constructor failed with error: ' . $e->getMessage() );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
	...
	public function run_two_stage_sync( bool $include_cases = true ): array {
		...
		if ( $existing_state && ! empty( $existing_state['session_id'] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Found existing sync state, attempting to resume...' );
		...
		if ( $registration_result ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Registered with BRAG book API - Job ID: ' . ( $registration_result['job_id'] ?? 'unknown' ) );
		}
		...
		try {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ===== STAGE 1: PROCEDURE SYNC =====' );
			$stage1_result = $this->sync_procedures_stage1();

			if ( ! $stage1_result['success'] ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Stage 1 failed, aborting sync' );
			...
			if ( $include_cases ) {
				...
				if ( empty( $stage1_result['sidebar_data_file'] ) || ! file_exists( $stage1_result['sidebar_data_file'] ) ) {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: ERROR - Sidebar data file not found from stage 1' );
					throw new Exception( 'Sidebar data file not available for stage 2' );
				}

				// Read sidebar data from file
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Loading sidebar data from file: ' . basename( $stage1_result['sidebar_data_file'] ) );
				...
				if ( ! empty( $stage1_result['sidebar_data_file'] ) && file_exists( $stage1_result['sidebar_data_file'] ) ) {
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: Cleaned up sync data file: ' . basename( $stage1_result['sidebar_data_file'] ) );
				}
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ===== FINAL SYNC SUMMARY =====' );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Status: " . ( $success ? 'SUCCESS' : 'COMPLETED WITH ERRORS' ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Procedures created: {$total_result['created']}" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Procedures updated: {$total_result['updated']}" );
			if ( $include_cases ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Cases created: {$total_result['cases_created']}" );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Cases updated: {$total_result['cases_updated']}" );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Total cases processed: {$total_result['total_cases_processed']}" );
			}
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Total errors: {$total_errors}" );

			$total_warnings = count( $total_result['warnings'] ?? [] );
			if ( $total_warnings > 0 ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Total warnings: {$total_warnings}" );
			}

			if ( ! empty( $total_result['errors'] ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Error details:' );
				foreach ( $total_result['errors'] as $error ) {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: - ' . $error );
				}
			}

			if ( ! empty( $total_result['warnings'] ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Warning details:' );
				foreach ( $total_result['warnings'] as $warning ) {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: - ' . $warning );
				}
			}
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ===== SYNC COMPLETE =====' );
			...
			if ( $this->database ) {
				try {
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: Orphan cleanup failed: ' . $e->getMessage() );
				}
			}
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Sync failed with exception: ' . $e->getMessage() );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Exception stack trace: ' . $e->getTraceAsString() );
			...
			if ( ! empty( $stage1_result['sidebar_data_file'] ) && file_exists( $stage1_result['sidebar_data_file'] ) ) {
				wp_delete_file( $stage1_result['sidebar_data_file'] );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Cleaned up sync data file on error: ' . basename( $stage1_result['sidebar_data_file'] ) );
			}
	...
	private function get_sync_data_dir(): string {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Sync data directory: ' . $sync_dir );

		// Create directory if it doesn't exist
		if ( ! file_exists( $sync_dir ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Creating sync data directory: ' . $sync_dir );
			$created = wp_mkdir_p( $sync_dir );
			if ( ! $created ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: ERROR - Failed to create sync directory' );
			}
		...
		if ( $files ) {
			foreach ( $files as $file ) {
				if ( filemtime( $file ) < $max_age ) {
					wp_delete_file( $file );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: Cleaned up old sync file: ' . basename( $file ) );
				}
			}
		}
	}
	...
	private function sync_procedures_stage1(): array {
		try {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Step 1 - Connecting to BRAGBook API...' );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✓ Successfully connected to API' );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Saving API data to file: ' . basename( $sync_file ) );
			$bytes_written = file_put_contents( $sync_file, wp_json_encode( $api_data ) );

			if ( $bytes_written === false ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: ERROR - Failed to save API data to file' );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Step 2 - Analyzing API response...' );

			if ( empty( $categories_data ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: ✗ No procedure data found in API response' );
				throw new Exception( esc_html( __( 'No data received from API', 'brag-book-gallery' ) ) );
			}

			$total_categories = count( $categories_data );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✓ Found ' . $total_categories . ' procedure categories to process' );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Step 3 - Processing procedure categories...' );
			...
			foreach ( $categories_data as $category_index => $category ) {
				...
				try {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Processing category {$category_count}/{$total_categories}: '{$category_name}'" );

					// Count child procedures
					$child_count = isset( $category['procedures'] ) ? count( $category['procedures'] ) : 0;
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Category '{$category_name}' contains {$child_count} procedures" );
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✓ Category '{$category_name}' processed - Created: {$created_in_category}, Updated: {$updated_in_category}" );
					...
					$errors[]  = $error_msg;
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✗ Failed to process category '{$category_name}': " . $e->getMessage() );
				}
			}
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Step 4 - Stage 1 completed' );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Stage 1 Status: " . ( $success ? 'SUCCESS' : 'COMPLETED WITH ERRORS' ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Categories processed: {$total_categories}" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Procedures created: {$total_created}" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Procedures updated: {$total_updated}" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Errors encountered: {$total_errors}" );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Stage 1 failed with exception: ' . $e->getMessage() );
			throw $e;
		}
	}
	...
	private function fetch_api_data(): array {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Preparing API request to: ' . $endpoint );

		// Get API tokens for authentication
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Retrieving API credentials...' );
		...
		if ( empty( $api_tokens ) || empty( $api_tokens[0] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✗ No API tokens configured in settings' );
		...
		if ( empty( $valid_tokens ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✗ No valid API tokens found after filtering' );
			throw new Exception( esc_html( __( 'No valid API tokens found. Please configure API settings first.', 'brag-book-gallery' ) ) );
		}

		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: ✓ Found ' . count( $valid_tokens ) . ' valid API token(s)' );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Using primary token: ' . substr( $valid_tokens[0], 0, 10 ) . '...' );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Connecting to: ' . $full_url );

		// Make GET request with Bearer token authentication
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Sending GET request to BRAGBook API...' );
		...
		if ( is_wp_error( $response ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ API request failed after {$request_time}ms (code: {$error_code}): {$error_message}" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Failed request URL: ' . $full_url );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: ✓ API responded in ' . $request_time . 'ms with status: ' . $response_code );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Response size: ' . strlen( $response_body ) . ' bytes' );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Response preview: ' . substr( $response_body, 0, 150 ) . '...' );
		...
		if ( stripos( $response_body, '<html' ) !== false || stripos( $response_body, '<!DOCTYPE' ) !== false ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: WARNING - Response appears to be HTML instead of JSON' );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Content-Type header: ' . wp_remote_retrieve_header( $response, 'content-type' ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Full HTML response: ' . $response_body );
		}

		if ( $response_code !== 200 ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: API returned non-200 status: ' . $response_code );
			throw new Exception( esc_html( sprintf(
		...
		if ( json_last_error() !== JSON_ERROR_NONE ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: JSON decode error: ' . json_last_error_msg() );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Response body (first 500 chars): ' . substr( $response_body, 0, 500 ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Response body length: ' . strlen( $response_body ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Response content type: ' . wp_remote_retrieve_header( $response, 'content-type' ) );
			throw new Exception( esc_html( sprintf(
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: API response data keys: ' . wp_json_encode( array_keys( $data ) ) );

		if ( ! isset( $data['data']['terms'] ) || ! is_array( $data['data']['terms'] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: API returned unexpected response structure. Keys: ' . wp_json_encode( array_keys( $data ) ) );
	 ...
	 * @param int $order Display order (position in the manifest)
	 *
	 * @return void
	 * @since 3.0.0
	 */
	private function update_procedure_meta( int $term_id, array $data, int $order = 0 ): void {
		...
		// Store the display order so the sidebar and nav views sort terms in the
		// same order as the BRAGBook application. Applied to both parent
		// categories and child procedures using their position in the manifest.
	...
	private function maybe_create_sync_table(): void {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Starting maybe_create_sync_table (HIPAA-compliant version)' );
		global $wpdb;

		$charset_collate = $wpdb->get_charset_collate();
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Got charset collate: ' . $charset_collate );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: About to require upgrade.php and run dbDelta' );
		require_once ABSPATH . 'wp-admin/includes/upgrade.php';
		dbDelta( $sql );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: dbDelta completed, HIPAA-compliant table creation finished' );
	...
	public function cleanup_old_logs(): void {
		...
		if ( $deleted > 0 ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: HIPAA compliance cleanup - Deleted {$deleted} old log entries" );
		}
	}
	...
	private function sync_cases_stage2( array $sidebar_data ): array {
		try {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Starting case synchronization...' );
			...
			if ( class_exists( 'QueryMonitor' ) || class_exists( 'QM' ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Disabling Query Monitor to conserve memory' );
			...
			$original_memory_limit = ini_get( 'memory_limit' );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Current memory limit: {$original_memory_limit}" );

			// Don't try to increase memory - work within the configured limit
			// This respects the server's memory configuration
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Working within configured memory limit of {$original_memory_limit}" );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Memory limit detected: {$memory_limit_mb} MB ({$memory_limit_bytes} bytes)" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Initial memory after cleanup: {$initial_memory_mb} MB ({$initial_memory_percent}% of limit)" );

			// Log memory status for monitoring
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Memory limit: {$memory_limit_mb} MB - Using optimized single-case processing" );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Found ' . count( $procedures ) . ' procedures to process' );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Procedure details: ' . wp_json_encode( $procedures ) );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Baseline expected cases from sidebar: ' . $baseline_expected_cases );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Processing all {$total_expected_cases} cases from API (no artificial limits)" );

			if ( empty( $procedures ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: No procedures found in sidebar data' );
			...
			foreach ( $procedures as $procedure_index => $procedure ) {
				...
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Extracted data for '{$procedure_name}' - IDs: " . wp_json_encode( $procedure_ids ) . ", case_count: {$case_count}" );

				try {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Entering try block for procedure '{$procedure_name}'" );
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Processing procedure '{$procedure_name}' with " . count( $procedure_ids ) . " IDs [" . implode( ', ', $procedure_ids ) . "] (" . ( $procedure_index + 1 ) . "/" . count( $procedures ) . ")" );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Procedure '{$procedure_name}' has {$case_count} total cases" );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Current memory: " . size_format( $current_memory ) . ", Peak: " . size_format( $peak_memory ) );
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Updating detailed progress for procedure start: {$procedure_name}" );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Overall: {$overall_percentage}%, Procedure: {$procedure_percentage}%, Cases processed: {$cases_processed_so_far}/{$total_expected_cases}" );
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✓ Detailed progress updated" );

					if ( $case_count <= 0 || empty( $procedure_ids ) ) {
						// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
						brag_book_log( "BRAG book Gallery Sync: Skipping procedure '{$procedure_name}' - no cases or IDs" );
						continue;
					}
					...
					if ( $current_memory > ( 400 * 1024 * 1024 ) ) { // 400MB threshold
						// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
						brag_book_log( "BRAG book Gallery Sync: ⚠ High memory usage detected: " . size_format( $current_memory ) );
					}
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: About to process procedure IDs for '{$procedure_name}': " . wp_json_encode( $procedure_ids ) );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Number of procedure IDs: " . count( $procedure_ids ) );

					if ( empty( $procedure_ids ) ) {
						// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
						brag_book_log( "BRAG book Gallery Sync: ✗ No procedure IDs found for '{$procedure_name}' - skipping" );
						continue; // Skip to next procedure
					}

					// Process each individual procedure ID separately
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Starting foreach loop for procedure IDs..." );
					foreach ( $procedure_ids as $id_index => $procedure_id ) {
						try {
							$procedure_id_start = microtime( true );
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: Processing individual procedure ID {$procedure_id} (" . ( $id_index + 1 ) . "/" . count( $procedure_ids ) . ") from '{$procedure_name}'" );
							...
							if ( ! $this->should_continue_processing() ) {
								// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
								brag_book_log( 'BRAG book Gallery Sync: Stopping sync - saving state for resume' );
							...
							if ( ! $wpdb->check_connection() ) {
								// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
								brag_book_log( 'BRAG book Gallery Sync: ✗ Database connection lost, attempting to reconnect...' );
								if ( ! $wpdb->check_connection( false ) ) {
									throw new Exception( 'Database connection lost and could not reconnect' );
								}
								// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
								brag_book_log( 'BRAG book Gallery Sync: ✓ Database connection restored' );
							}

							// Stream process cases to avoid loading all IDs into memory at once
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: Starting streaming case processing for procedure ID {$procedure_id}..." );
							...
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( 'BRAG book Gallery Sync: Using optimized single-case processing for memory efficiency' );
							$page                      = 1;
							$procedure_cases_processed = 0;
							...
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: Starting while loop for procedure ID {$procedure_id}, page {$page}, max pages: {$max_pages_per_procedure}" );
							while ( $page <= $max_pages_per_procedure ) {
								// Check if we should continue processing
								if ( ! $this->should_continue_processing() ) {
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( 'BRAG book Gallery Sync: Stopping sync in batch loop - saving state' );
								...
								try {
									...
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: About to fetch case IDs for procedure ID {$procedure_id}, page {$page}, batch_size {$batch_size}" );
									...
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: Fetch completed for procedure ID {$procedure_id}, page {$page} - got " . count( $case_batch ) . " case IDs in {$fetch_duration}s" );
									if ( empty( $case_batch ) ) {
										$empty_page_count ++;
										// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
										brag_book_log( "BRAG book Gallery Sync: Empty page {$page} for procedure ID {$procedure_id} (empty count: {$empty_page_count})" );

										// Break after consecutive empty pages
										if ( $empty_page_count >= $max_consecutive_issues ) {
											// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
											brag_book_log( "BRAG book Gallery Sync: Found {$empty_page_count} consecutive empty pages, ending procedure {$procedure_id}" );
											break;
										}
									...
									if ( empty( $new_case_ids ) ) {
										...
										// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
										brag_book_log( "BRAG book Gallery Sync: All cases in page {$page} are duplicates (count: {$duplicate_page_count})" );

										// Break after too many consecutive duplicate pages
										if ( $duplicate_page_count >= $max_consecutive_issues ) {
											// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
											brag_book_log( "BRAG book Gallery Sync: {$duplicate_page_count} consecutive duplicate pages, ending procedure {$procedure_id}" );
											break;
										}
									...
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: *** Processing BATCH {$page} for procedure '{$procedure_name}' ({$batch_case_count} cases) ***" );
									...
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: *** COMPLETED BATCH {$page} for procedure '{$procedure_name}' in {$batch_duration}s ***" );
									...
									// Log batch summary
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: === BATCH {$page} SUMMARY: {$batch_case_count} cases processed ({$batch_created} created, {$batch_updated} updated) ===" );
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: Procedure '{$procedure_name}' progress: {$procedure_cases_processed} cases total" );
									...
									if ( $memory_percentage > $cleanup_threshold ) {
										// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
										brag_book_log( sprintf( "BRAG book Gallery Sync: Memory at %.1f%% (%s / %s) - performing aggressive cleanup (threshold: %d%%)",
											$memory_percentage,
											size_format( $current_memory ),
											size_format( $memory_limit ),
											$cleanup_threshold
										...
										// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
										brag_book_log( sprintf( "BRAG book Gallery Sync: Memory freed: %s, now at %.1f%% (%s / %s)",
										...
										if ( ( $new_memory / $memory_limit ) * 100 > $critical_threshold ) {
											// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
											brag_book_log( sprintf( "BRAG book Gallery Sync: CRITICAL - Memory at %.1f%% after cleanup (critical threshold: %d%%). Considering pause.",
												( $new_memory / $memory_limit ) * 100,
												$critical_threshold
											) );
											...
											if ( $memory_limit_mb < 128 ) {
												// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
												brag_book_log( "BRAG book Gallery Sync: Low memory system - may need to save state and resume" );
											}
										}
									}
									...
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: Forcing progress update - Overall: {$overall_percentage}%, Procedure: {$procedure_cases_processed}/{$actual_case_count}" );
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: Recent cases for display: " . wp_json_encode( $recent_cases ) );
									$this->update_detailed_progress( [
										'stage'                => 'cases',
										'overall_percentage'   => round( $overall_percentage, 1 ),
										'current_procedure'    => $procedure_name,
									...
									$errors[]  = $error_msg;
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: ✗ {$error_msg}" );
									// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
									brag_book_log( "BRAG book Gallery Sync: Exception trace: " . $e->getTraceAsString() );
							...
							try {
								...
								// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
								brag_book_log( "BRAG book Gallery Sync: Failed to store case order for procedure {$procedure_id}: " . $e->getMessage() );
							...
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: Memory cleanup after case order update - Freed: " . size_format( max( 0, $memory_freed ) ) );

							// Log procedure completion
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: Completed procedure '{$procedure_name}' with {$procedure_cases_processed} cases processed" );

							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: Completed procedure ID {$procedure_id} - processed {$procedure_cases_processed} cases" );
							...
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: ✗ Failed to process procedure ID {$procedure_id}: " . $e->getMessage() );
						}
					}

					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Completed all IDs for procedure '{$procedure_name}'" );
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Memory cleanup after '{$procedure_name}' - Freed: " . size_format( max( 0, $memory_freed ) ) );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Current memory usage: " . size_format( $memory_after ) . ", Peak: " . size_format( memory_get_peak_usage( true ) ) );

				} catch ( Exception $e ) {
					$errors[] = "Failed to process procedure '{$procedure_name}': " . $e->getMessage();
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✗ Failed to process procedure '{$procedure_name}': " . $e->getMessage() );
				}
			}

			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Stage 2 completed' );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Cases created: {$created_cases}" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Cases updated: {$updated_cases}" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Total processed: {$total_processed}" );
			...
			if ( $expected_total > $actual_total ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ⚠ COUNT MISMATCH! Created ({$created_cases}) + Updated ({$updated_cases}) = {$expected_total}, but unique cases processed = {$actual_total}" );
				...
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✓ Case count verified: Created ({$created_cases}) + Updated ({$updated_cases}) = {$actual_total} unique cases" );
			}

			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Errors: " . count( $errors ) );
			if ( ! empty( $warnings ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Warnings: " . count( $warnings ) );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Stage 2 failed with exception: ' . $e->getMessage() );
	...
	private function extract_procedures_from_sidebar( array $sidebar_data ): array {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Sidebar data keys: ' . wp_json_encode( array_keys( $sidebar_data ) ) );

		$terms = $sidebar_data['data']['terms'] ?? [];
		if ( empty( $terms ) || ! is_array( $terms ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: No terms array found in sidebar data' );

			return $procedures;
		}

		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Found ' . count( $terms ) . ' categories in terms data' );

		foreach ( $terms as $category_index => $category ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Processing category {$category_index}: " . wp_json_encode( array_keys( $category ) ) );

			if ( isset( $category['procedures'] ) && is_array( $category['procedures'] ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Category {$category_index} has " . count( $category['procedures'] ) . ' procedures' );

				foreach ( $category['procedures'] as $procedure_index => $procedure ) {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Processing procedure {$procedure_index}: " . wp_json_encode( array_keys( $procedure ) ) );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Procedure data: " . wp_json_encode( $procedure ) );
					...
					if ( ! empty( $procedure['id'] ) ) {
						...
						// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
						brag_book_log( "BRAG book Gallery Sync: Added procedure: " . wp_json_encode( $procedure_data ) );
						$procedures[] = $procedure_data;
					} else {
						// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
						brag_book_log( "BRAG book Gallery Sync: Skipped procedure - missing ID: " . wp_json_encode( $procedure ) );
					}
				}
			} else {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Category {$category_index} has no procedures array" );
			}
		}
	...
	private function fetch_case_ids_paginated( int $procedure_id, int $page, int $per_page = 10 ): array {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: fetch_case_ids_paginated() ENTRY - procedure_id: {$procedure_id}, page: {$page}" );
		try {
			// Use the existing count-based API but calculate the count number from page
			$count = $page; // The API uses 'count' as page number
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: About to call fetch_case_ids_for_single_procedure_count() with procedure_id: {$procedure_id}, count: {$count}" );
			$case_ids = $this->fetch_case_ids_for_single_procedure_count( $procedure_id, $count );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: fetch_case_ids_for_single_procedure_count() returned " . count( $case_ids ) . " case IDs" );

			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Procedure ID {$procedure_id} page {$page} - fetched " . count( $case_ids ) . " case IDs" );

			return $case_ids ?: [];
		} catch ( Exception $e ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ EXCEPTION in fetch_case_ids_paginated() - procedure {$procedure_id} page {$page}: " . $e->getMessage() );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ Exception trace: " . $e->getTraceAsString() );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: fetch_case_ids_paginated() EXIT - procedure_id: {$procedure_id}, page: {$page}" );
	}
	...
	private function fetch_all_case_ids_for_single_procedure( int $procedure_id ): array {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Starting to fetch all cases for procedure ID {$procedure_id}" );

		while ( $has_more_cases ) {
			try {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Fetching with count {$count} for procedure ID {$procedure_id}" );
				$case_ids = $this->fetch_case_ids_for_single_procedure_count( $procedure_id, $count );
				...
				if ( empty( $case_ids ) ) {
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: No more cases found at count {$count} for procedure ID {$procedure_id}" );
				} else {
					$all_case_ids = array_merge( $all_case_ids, $case_ids );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Count {$count} returned " . count( $case_ids ) . " case IDs for procedure ID {$procedure_id}" );
					$count ++;
				...
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✗ Failed to fetch count {$count} for procedure ID {$procedure_id}: " . $e->getMessage() );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Procedure ID {$procedure_id} - total unique case IDs: " . count( $unique_case_ids ) );
	...
	private function fetch_case_ids_for_single_procedure_count( int $procedure_id, int $page, int $limit = 50, bool $tablet = false ): array {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Fetching procedure ' . $procedure_id . ' page ' . $page . ' (v2 API)' . ( $tablet ? ' (tablet mode)' : '' ) );
		...
		if ( isset( $response['data']['cases'] ) && is_array( $response['data']['cases'] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Found ' . count( $response['data']['cases'] ) . ' cases for procedure ' . $procedure_id . ' page ' . $page );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: No cases found in v2 response for procedure ' . $procedure_id . ' page ' . $page );
		}

		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Procedure ' . $procedure_id . ' page ' . $page . ' returned ' . count( $case_ids ) . ' case IDs' );
	...
	private function fetch_case_ids_for_procedure_page( array $procedure_ids, int $page, int $count = 10 ): array {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Fetching procedures [' . implode( ', ', $procedure_ids ) . '] page ' . $page . ' (start: ' . $request_body['start'] . ', count: ' . $count . ')' );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Request body: ' . wp_json_encode( $request_body ) );
		...
		if ( $response_code !== 200 ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: API error response for procedures [' . implode( ', ', $procedure_ids ) . '] page ' . $page . ': ' . $response_body );
			throw new Exception( esc_html( sprintf(
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Procedures [' . implode( ', ', $procedure_ids ) . '] page ' . $page . ' returned ' . count( $case_ids ) . ' case IDs' );
	...
	private function process_case_batch( array $case_batch, string $procedure_name, int $procedure_id ): array {
		try {
			$batch_size = count( $case_batch );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: process_case_batch() starting with {$batch_size} cases from procedure '{$procedure_name}'" );
			...
			foreach ( $case_batch as $case_id ) {
				try {
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Failed to fetch case {$case_id}: " . $e->getMessage() );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: API fetch completed in {$fetch_duration}s for {$batch_size} cases" );
			...
			foreach ( $case_batch as $case_id ) {
				try {
					...
					if ( ! $case_data ) {
						// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
						brag_book_log( "BRAG book Gallery Sync: No data found for case {$case_id} in batch results" );
					...
					if ( ! isset( $case_data['isForWebsite'] ) || ! $case_data['isForWebsite'] ) {
						...
						if ( $existing_post ) {
							// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
							brag_book_log( "BRAG book Gallery Sync: Deleting existing case {$case_id} (post ID: {$existing_post->ID}) - no longer approved for website" );
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✗ Failed to process case {$case_id} in batch: " . $e->getMessage() );
					$batch_results[] = [
						'case_id' => $case_id,
						'post_id' => null,
						'created' => false,
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: process_case_batch() completed {$batch_size} cases from procedure '{$procedure_name}'" );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ process_case_batch() failed critically: " . $e->getMessage() );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Exception stack trace: " . $e->getTraceAsString() );
			throw $e;
		}
	...
	private function fetch_single_case_details( int $case_id ): ?array {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Fetching single case {$case_id}" );
		...
		if ( empty( $api_tokens ) || empty( $api_tokens[0] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: No API tokens configured" );
		...
		if ( is_wp_error( $response ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Failed to fetch case {$case_id}: " . $response->get_error_message() );
		...
		if ( $response_code !== 200 ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: HTTP {$response_code} for case {$case_id}" );
		...
		if ( json_last_error() !== JSON_ERROR_NONE ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: JSON error for case {$case_id}: " . json_last_error_msg() );
		...
		if ( ! isset( $data['success'] ) || ! $data['success'] || ! isset( $data['data'][0] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Invalid API response for case {$case_id}" );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Successfully fetched case {$case_id}" );
	...
	private function fetch_case_details_batch( array $case_ids ): array {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: fetch_case_details_batch() starting for {$batch_size} cases: " . implode( ', ', $case_ids ) );
		...
		if ( empty( $api_tokens ) || empty( $api_tokens[0] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ No API tokens configured for batch fetch" );
			throw new Exception( esc_html( __( 'No API tokens configured', 'brag-book-gallery' ) ) );
		}
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Parallel API requests for {$batch_size} cases completed in {$request_duration}ms" );
		...
		foreach ( $case_ids as $case_id ) {
			...
			if ( ! empty( $curl_error ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: cURL error for case {$case_id}: {$curl_error}" );
			...
			if ( $http_code !== 200 ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: HTTP error {$http_code} for case {$case_id}: " . substr( $response_body, 0, 200 ) );
				$case_results[ $case_id ] = null;
				continue;
			}
			...
			if ( json_last_error() !== JSON_ERROR_NONE ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: JSON decode error for case {$case_id}: " . json_last_error_msg() );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Case {$case_id} response body (first 500 chars): " . substr( $response_body, 0, 500 ) );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Case {$case_id} response body length: " . strlen( $response_body ) );
				$case_results[ $case_id ] = null;
				continue;
			}
			...
			if ( ! isset( $data['success'] ) || ! $data['success'] ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: API returned unsuccessful response for case {$case_id}" );
				$case_results[ $case_id ] = null;
				continue;
			}
			...
			if ( ! isset( $data['data'][0] ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: No case data found in API response for case {$case_id}" );
				$case_results[ $case_id ] = null;
				continue;
			}
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Successfully fetched case details for case {$case_id}" );
		}
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: fetch_case_details_batch() completed - {$successful_fetches}/{$batch_size} successful fetches" );
	...
	private function process_multi_procedure_case( int $case_id, array $case_data, ?\WP_Post $existing_post = null ): array {
		...
		if ( empty( $procedure_ids ) || ! is_array( $procedure_ids ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: No procedures found for case {$case_id}, creating single case" );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Case {$case_id} has {$procedure_count} procedures (IDs: " . implode( ', ', $procedure_ids ) . "), using strategy: {$strategy}" );

		// If only one procedure, always use single post approach regardless of strategy
		if ( $procedure_count === 1 ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Single procedure case {$case_id}, creating single post" );
			$single_result = $this->create_single_case_post( $case_id, $case_data, $existing_post );
		...
		if ( $strategy === 'single_post' ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Creating single post with multiple procedure taxonomies for case {$case_id}" );
			$single_result = $this->create_single_case_post( $case_id, $case_data, $existing_post );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Creating separate posts for each procedure in case {$case_id}" );
		...
		foreach ( $procedure_ids as $procedure_index => $procedure_id ) {
			try {
				...
				if ( $is_update ) {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Updating existing procedure case {$procedure_case_id} (post ID: {$existing_procedure_post->ID})..." );
					$post_id = $this->update_case_post( $existing_procedure_post->ID, $procedure_case_data );
				} else {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Creating new procedure case post {$procedure_case_id}..." );
				...
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✓ Successfully processed procedure case {$procedure_case_id}" );

			} catch ( Exception $e ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✗ Failed to process procedure case {$procedure_case_id}: " . $e->getMessage() );
				$procedure_results[] = [
		...
		if ( $existing_post && count( $procedure_ids ) > 1 ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Cleaning up old single case post {$existing_post->ID} for multi-procedure case {$case_id}" );
	...
	private function create_single_case_post( int $case_id, array $case_data, ?\WP_Post $existing_post = null ): array {
		...
		if ( $is_update ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Updating existing case {$case_id} (post ID: {$existing_post->ID})..." );
			$post_id = $this->update_case_post( $existing_post->ID, $case_data );
		} else {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Creating new case post for case {$case_id}..." );
		...
		$this->maybe_assign_provider_taxonomy( $post_id, $case_data );
	...
	private function assign_single_procedure_taxonomy( int $post_id, int $procedure_id ): void {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: assign_single_procedure_taxonomy() - Attempting to assign procedure ID {$procedure_id} to post {$post_id}" );
		...
		if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Assigned procedure term '{$terms[0]->name}' (ID: {$terms[0]->term_id}) to post {$post_id}" );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: DEBUG - Could not find procedure term for procedure ID {$procedure_id}" );
		$all_terms = get_terms( [
			'taxonomy'   => Taxonomies::TAXONOMY_PROCEDURES,
			'hide_empty' => false,
		] );
		...
		if ( ! empty( $all_terms ) && ! is_wp_error( $all_terms ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: DEBUG - Available procedure terms:" );
			foreach ( array_slice( $all_terms, 0, 10 ) as $term ) { // Show first 10 terms
				$stored_id = get_term_meta( $term->term_id, 'procedure_id', true );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "  - Term: '{$term->name}' (ID: {$term->term_id}, slug: {$term->slug}, stored procedure_id: {$stored_id})" );
			}
		}
		...
		if ( ! empty( $terms_with_api_data ) && ! is_wp_error( $terms_with_api_data ) ) {
			foreach ( $terms_with_api_data as $term ) {
				...
				if ( is_array( $api_data ) && isset( $api_data['api_id'] ) && (int) $api_data['api_id'] === $procedure_id ) {
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✓ Assigned procedure term '{$term->name}' (via api_data match) to post {$post_id}" );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: ✗ Could not find procedure term for procedure ID {$procedure_id}, assigning fallback" );
	...
	private function process_single_case( int $case_id ): array {
		try {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: process_single_case() starting for case {$case_id}" );

			// Fetch case details from API
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Fetching case details for case {$case_id}..." );
			$case_data = $this->fetch_case_details( $case_id );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Case details fetched for case {$case_id}" );
			...
			// Check if case already exists
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Checking if case {$case_id} already exists..." );
			$existing_post = $this->find_existing_case_post( $case_id );
			$is_update     = ! empty( $existing_post );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Case {$case_id} " . ( $is_update ? "exists (post ID: {$existing_post->ID})" : "does not exist" ) );
			...
			if ( $is_update ) {
				...
				$post_id = $this->update_case_post( $existing_post->ID, $case_data );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✓ Case {$case_id} updated successfully" );
			} else {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Creating new case post for case {$case_id}..." );
				$post_id = $this->create_case_post( $case_data );
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✓ Case {$case_id} created successfully with post ID: {$post_id}" );
			}
			...
			// Save API data to meta fields
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Saving API data to meta fields for case {$case_id}..." );
			\BRAGBookGallery\Includes\Extend\Post_Types::save_api_response_data( $post_id, $case_data );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ API data saved for case {$case_id}" );

			// Assign taxonomies
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Assigning taxonomies for case {$case_id}..." );
			$this->assign_case_taxonomies( $post_id, $case_data );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Taxonomies assigned for case {$case_id}" );

			// Log the operation
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Logging operation for case {$case_id}..." );
			$this->log_case_operation( $post_id, $case_data, ! $is_update );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Operation logged for case {$case_id}" );

			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: process_single_case() completed successfully for case {$case_id}" );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ process_single_case() failed for case {$case_id}: " . $e->getMessage() );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Exception stack trace: " . $e->getTraceAsString() );
			throw $e;
		}
	...
	private function fetch_case_details( int $case_id ): array {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: fetch_case_details() starting for case {$case_id} (v2 API)" );
		...
		if ( empty( $api_token ) || $website_property_id <= 0 ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ Invalid API configuration for case {$case_id}" );
			throw new Exception( esc_html( __( 'Invalid API configuration', 'brag-book-gallery' ) ) );
		}
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: API request for case {$case_id} completed in {$request_duration}ms" );

		if ( ! $response || ! isset( $response['data']['case'] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ No case data found in v2 API response for case {$case_id}" );
	...
	private function normalize_v2_case_data( array $v2_data ): array {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "=== DATA_SYNC NORMALIZATION DEBUG: Case {$case_id} ===" );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "V2 Data Keys: " . implode( ', ', array_keys( $v2_data ) ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Has patientInfo: " . ( isset( $v2_data['patientInfo'] ) ? 'YES' : 'NO' ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Has seoInfo: " . ( isset( $v2_data['seoInfo'] ) ? 'YES' : 'NO' ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Has photoSets: " . ( isset( $v2_data['photoSets'] ) ? 'YES (' . count( $v2_data['photoSets'] ) . ' sets)' : 'NO' ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Has postOp: " . ( isset( $v2_data['postOp'] ) ? 'YES' : 'NO' ) );
		if ( isset( $v2_data['postOp'] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log, WordPress.PHP.DevelopmentFunctions.error_log_print_r
			brag_book_log( "postOp data in v2: " . print_r( $v2_data['postOp'], true ) );
		}

		if ( isset( $v2_data['photoSets'][0]['images'] ) ) {
			$first_images = $v2_data['photoSets'][0]['images'];
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "First photoSet image keys: " . implode( ', ', array_keys( $first_images ) ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "Before URL: " . ( $first_images['before']['url'] ?? 'MISSING' ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "After URL: " . ( $first_images['after']['url'] ?? 'MISSING' ) );
		}
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Normalized Data Keys: " . implode( ', ', array_keys( $normalized ) ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Normalized age: " . ( $normalized['age'] ?? 'NULL' ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Normalized gender: " . ( $normalized['gender'] ?? 'NULL' ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Normalized photoSets count: " . ( isset( $normalized['photoSets'] ) ? count( $normalized['photoSets'] ) : '0' ) );
		if ( isset( $normalized['photoSets'][0] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "First normalized photoSet keys: " . implode( ', ', array_keys( $normalized['photoSets'][0] ) ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "Normalized beforeLocationUrl: " . ( $normalized['photoSets'][0]['beforeLocationUrl'] ?? 'MISSING' ) );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "Normalized afterLocationUrl1: " . ( $normalized['photoSets'][0]['afterLocationUrl1'] ?? 'MISSING' ) );
		}
		if ( isset( $normalized['caseDetails'][0] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "Normalized seoPageTitle: " . ( $normalized['caseDetails'][0]['seoPageTitle'] ?? 'MISSING' ) );
		}
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "Normalized has postOp: " . ( isset( $normalized['postOp'] ) ? 'YES' : 'NO' ) );
		if ( isset( $normalized['postOp'] ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log, WordPress.PHP.DevelopmentFunctions.error_log_print_r
			brag_book_log( "Normalized postOp data: " . print_r( $normalized['postOp'], true ) );
		}
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "=== END DATA_SYNC NORMALIZATION DEBUG ===" );
...
<!-- Case ID: %d, Procedure ID: %d, Synced: %s -->',
	...
	private function generate_case_slug( array $case_data ): string {
		...
		if ( isset( $case_data['seoInfo']['slug'] ) && ! empty( $case_data['seoInfo']['slug'] ) ) {
			...
			if ( ! empty( $slug ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Using seoInfo.slug for case ' . $case_id . ': ' . $slug );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Using fallback slug for case ' . $case_id . ': ' . $fallback_slug );
	...
	private function assign_case_taxonomies( int $post_id, array $case_data ): void {
		...
		if ( empty( $procedure_ids ) || ! is_array( $procedure_ids ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ No procedure IDs found for post {$post_id}, assigning fallback procedure" );
		...
		foreach ( $procedure_ids as $procedure_id ) {
			...
			if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
				...
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✗ Could not find procedure term for procedure ID {$procedure_id} on post {$post_id}" );
			}
		}
		...
		if ( ! empty( $term_ids ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Assigned " . count( $term_ids ) . " procedure terms to post {$post_id}" );
		} else {
			// FALLBACK: No matching procedure terms found, assign a default
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ No matching procedure terms found for post {$post_id}, assigning fallback" );
			$this->assign_fallback_procedure( $post_id );
		}
	}
	...
	private function assign_fallback_procedure( int $post_id, ?int $original_procedure_id = null ): void {
		...
		if ( $original_procedure_id ) {
			...
			if ( $created_term ) {
				...
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✓ Created and assigned missing procedure term for ID {$original_procedure_id} to post {$post_id}" );
		...
		if ( ! empty( $fallback_terms ) && ! is_wp_error( $fallback_terms ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Assigned fallback procedure '{$fallback_terms[0]->name}' to post {$post_id}" );
		...
		if ( ! is_wp_error( $fallback_term ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Created and assigned 'Other Procedures' fallback category to post {$post_id}" );
		...
		if ( ! empty( $any_terms ) && ! is_wp_error( $any_terms ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Assigned to most common procedure '{$any_terms[0]->name}' as last resort for post {$post_id}" );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: ✗ CRITICAL: Could not assign any procedure to post {$post_id} - no procedures exist in taxonomy!" );
	}
	...
	private function create_missing_procedure_term( int $procedure_id ): ?\WP_Term {
		try {
			...
			if ( is_wp_error( $result ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: ✗ Failed to create procedure term for ID {$procedure_id}: " . $result->get_error_message() );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Created missing procedure term '{$procedure_name}' for ID {$procedure_id}" );

			return $term;

		} catch ( Exception $e ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✗ Exception creating procedure term for ID {$procedure_id}: " . $e->getMessage() );
	...
	public function validate_and_fix_unassigned_cases(): array {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Starting validation of cases without procedures..." );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Found {$total_found} cases without procedure assignments" );
		...
		if ( $unassigned_posts->have_posts() ) {
			foreach ( $unassigned_posts->posts as $post_id ) {
				try {
					...
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✓ Fixed procedure assignment for post {$post_id}" );

				} catch ( Exception $e ) {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: ✗ Failed to fix procedure assignment for post {$post_id}: " . $e->getMessage() );
					$fixed_cases[] = [
						'post_id' => $post_id,
						'method'  => 'failed',
						'error'   => $e->getMessage(),
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Validation complete - Fixed: {$fixed_count}, Failed: {$failed_count}" );
	...
	private function update_detailed_progress( array $progress_data ): void {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: update_option result: " . ( $update_result ? 'SUCCESS' : 'FAILED' ) );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Verified saved updated_at: {$saved_updated_at}" );
	...
	private function update_step_progress( string $step_message ): void {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Step Update - {$step_message}" );
	}
	...
	private function update_case_progress( int $processed, int $total, string $message ): void {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: Progress update - {$overall_percentage}% ({$processed}/{$total}): {$message}" );
	}
	...
	private function ensure_taxonomy_registered(): void {
		...
		if ( taxonomy_exists( \BRAGBookGallery\Includes\Extend\Taxonomies::TAXONOMY_PROCEDURES ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✓ Procedures taxonomy already registered' );

			return;
		}

		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Procedures taxonomy not found, forcing registration...' );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: ✓ Procedures taxonomy registration forced successfully' );
	}
	...
	private function ensure_favorites_page_exists(): void {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Checking for My Favorites page...' );
		...
		if ( empty( $gallery_page ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✗ Gallery page not found with slug: ' . $gallery_slug );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Found gallery page (ID: ' . $gallery_page_id . ', slug: ' . $gallery_slug . ')' );
		...
		if ( ! empty( $existing_page ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✓ My Favorites page already exists as child (ID: ' . $existing_page[0]->ID . ')' );
		...
		if ( ! empty( $shortcode_page ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✓ Found existing page with favorites shortcode, marked it as favorites page (ID: ' . $shortcode_page[0]->ID . ')' );
		...
		if ( is_wp_error( $page_id ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✗ Failed to create My Favorites page: ' . $page_id->get_error_message() );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: ✓ Created My Favorites page successfully (ID: ' . $page_id . ')' );
	}
	...
	private function init_sync_status_file(): void {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Sync status file path: ' . $this->sync_status_file );
	}
	...
	private function init_sync_api(): void {
		try {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Sync API initialized' );
		} catch ( \Exception $e ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Failed to initialize Sync API: ' . $e->getMessage() );
			$this->sync_api = null;
	...
	private function register_sync_with_api(): ?array {
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: register_sync_with_api() called' );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: enable_sync_reporting = ' . ( $this->enable_sync_reporting ? 'true' : 'false' ) );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: sync_api = ' . ( $this->sync_api ? 'initialized' : 'null' ) );

		if ( ! $this->enable_sync_reporting || ! $this->sync_api ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Skipping registration - sync reporting disabled or API not initialized' );
			return null;
		}
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Calling sync_api->register_sync() with type: ' . $this->sync_type );
		$result = $this->sync_api->register_sync( $this->sync_type, null, $trigger_job_id );

		if ( is_wp_error( $result ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Failed to register sync: ' . $result->get_error_message() );
			return null;
		}

		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Registration successful: ' . wp_json_encode( $result ) );
		return $result;
	}
	...
	private function report_sync_status( string $status, array $data = [] ): ?array {
		...
		if ( is_wp_error( $result ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Failed to report sync status: ' . $result->get_error_message() );
			return null;
		}
	...
	private function write_sync_status_file( array $progress ): void {
		try {
			...
			if ( $json_data !== false ) {
				...
				if ( $bytes_written === false ) {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: Failed to write sync status file' );
				} else {
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( 'BRAG book Gallery Sync: Wrote ' . $bytes_written . ' bytes to sync status file' );
				}
			} else {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( 'BRAG book Gallery Sync: Failed to encode progress data to JSON' );
			}
		} catch ( Exception $e ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Error writing sync status file: ' . $e->getMessage() );
		}
	}
	...
	public function clear_sync_status_file(): void {
		if ( file_exists( $this->sync_status_file ) ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Cleared sync status file' );
		}
	}
	...
	private function store_procedure_case_order_list( int $procedure_id, array $case_ids_in_order ): void {
		try {
			...
			if ( empty( $terms ) || is_wp_error( $terms ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Warning - No procedure term found for procedure ID {$procedure_id}" );
			...
			if ( empty( $case_ids_in_order ) ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: No cases to store for procedure {$procedure_id}" );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: ✓ Stored case order list for procedure {$procedure_id} (term: {$term->term_id}) - " . count( $case_ids_in_order ) . " cases" );
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: First 5 cases in order: " . implode( ', ', array_slice( $case_ids_in_order, 0, 5 ) ) );
		} catch ( \Exception $e ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Error storing case order list for procedure {$procedure_id}: " . $e->getMessage() );
		}
	}
	...
	public static function get_ordered_cases_for_procedure( int $procedure_id ): array {
		...
		if ( ! is_array( $case_ids_in_order ) || empty( $case_ids_in_order ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery: No case order list found for procedure {$procedure_id} (term: {$term->term_id})" );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery: Retrieved " . count( $ordered_post_ids ) . " ordered post IDs for procedure {$procedure_id}" );
	...
	private function should_continue_processing(): bool {
		...
		if ( $elapsed_time >= $this->max_execution_time ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Execution time limit reached ({$elapsed_time}s >= {$this->max_execution_time}s)" );
		...
		if ( $memory_limit > 0 ) {
			...
			if ( $memory_percent >= $this->max_memory_percent ) {
				// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
				brag_book_log( "BRAG book Gallery Sync: Memory limit reached ({$memory_percent}% >= {$this->max_memory_percent}%)" );
		...
		if ( get_option( 'brag_book_gallery_sync_stop_flag', false ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Stop flag detected' );
	...
	private function save_sync_state( array $state ): void {
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Saved sync state for resumption' );
	}
	...
	private function clear_sync_state(): void {
		...
		delete_option( 'brag_book_gallery_sync_stop_flag' );
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( 'BRAG book Gallery Sync: Cleared sync state' );
	}
	...
	private function cleanup_array( array &$array, int $max_size = 1000, int $keep_size = 500 ): void {
		if ( count( $array ) > $max_size ) {
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Cleaned up array from ' . $max_size . ' to ' . $keep_size . ' items' );
		}
	}
	...
	private function maybe_assign_provider_taxonomy( int $post_id, array $case_data ): void {
		...
		if ( ! taxonomy_exists( Taxonomies::TAXONOMY_PROVIDERS ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: Providers taxonomy is enabled but not registered' );
		...
		if ( empty( $providers ) || ! is_array( $providers ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: No providers data found for post {$post_id}" );
		...
		if ( empty( $term_ids ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: No provider terms resolved for post {$post_id}" );
		...
		if ( is_wp_error( $result ) ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Failed to assign provider terms to post {$post_id}: " . $result->get_error_message() );
		} else {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: ✓ Assigned ' . count( $term_ids ) . " provider term(s) to post {$post_id}" );
		}
	}
	...
	private function create_or_update_provider_term( array $provider_data ): ?\WP_Term {
		...
		if ( get_option( 'brag_book_gallery_debug_mode' ) === 'yes' ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( 'BRAG book Gallery Sync: provider object for member ' . $member_id . ' keys=[' . implode( ',', array_keys( $provider_data ) ) . '] imageUrl=' . ( isset( $provider_data['imageUrl'] ) ? (string) $provider_data['imageUrl'] : '(absent)' ) );
		}
		...
		if ( is_wp_error( $result ) ) {
			...
			if ( $result->get_error_code() === 'term_exists' ) {
				...
				if ( $term && ! is_wp_error( $term ) ) {
					...
					$this->update_provider_term_meta( $term->term_id, $meta );
					// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
					brag_book_log( "BRAG book Gallery Sync: Using existing provider term '{$provider_name}' (term ID: {$term->term_id})" );
			...
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			brag_book_log( "BRAG book Gallery Sync: Failed to create provider term '{$provider_name}': " . $result->get_error_message() );
		...
		// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		brag_book_log( "BRAG book Gallery Sync: ✓ Created new provider term '{$provider_name}' (term ID: {$term_id})" );
	...
	private function maybe_sync_provider_practices( int $provider_id, int $provider_term_id ): void {
		...
		$api_token = $this->get_registry_api_token();
		if ( empty( $api_token ) ) {
			return;
		}

		$endpoints = new \BRAGBookGallery\Includes\REST\Endpoints();
		$response  = $endpoints->get_practices_v2( $api_token, $provider_id );
