...
is what changed since 4.9.3.

### Added

- **The gallery shortcode chooses the element its title is written in**:
  ...
  anything else falls back to the `<h1>` the gallery has always used.
