...
/* harmony import */ var _utilities_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities.js */ "./src/js/modules/utilities.js");
/**
 * Sync Dialog Module
 *
    ...
    dialog.innerHTML = `
			<div class="brag-book-gallery-dialog-content">
				<div class="brag-book-gallery-dialog-header">
					<h3 class="brag-book-gallery-dialog-title">${(0,_utilities_js__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(title)}</h3>
				...
				<div class="brag-book-gallery-dialog-body">
					...
					<div class="brag-book-gallery-dialog-message">
						${(0,_utilities_js__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(message)}
					</div>
				</div>
			...
			<div class="brag-book-gallery-dialog-content">
				...
				<div class="brag-book-gallery-dialog-footer">
					<button type="button" class="button button-secondary" data-action="cancel">
						${(0,_utilities_js__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(options.cancelText)}
					</button>
					<button type="button" class="button ${options.confirmButtonClass}" data-action="confirm">
						${(0,_utilities_js__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(options.confirmText)}
					</button>
				</div>
			</div>
		`;
  ...
  async loadManifestPreview() {
    try {
      ...
      if (response.success && response.data.exists) {
        const data = response.data;
        const html = `<div>` + `<strong>Procedures:</strong> ${data.total_procedures} &nbsp; ` + `<strong>Cases:</strong> ${data.total_cases} &nbsp; ` + `<strong>Built:</strong> ${data.date}` + `</div>`;
