...
if (typeof window.BRAGbookSyncAdmin === 'undefined') {
  window.BRAGbookSyncAdmin = class {
    ...
    showRemoteSyncBanner(activeSyncData) {
      ...
      banner.style.cssText = ['background:#fff8e1', 'border:1px solid #f9a825', 'border-radius:4px', 'padding:12px 16px', 'margin-bottom:16px', 'display:flex', 'align-items:center', 'gap:12px', 'font-size:13px'].join(';');
      banner.innerHTML = `
