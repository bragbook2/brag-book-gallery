...
function createCaseNavButton(direction) {
  ...
  const path = isNext ? 'm560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z' : 'M400-240 160-480l240-240 56 58-142 142h486v80H314l142 142-56 58Z';
...
/**
 * Load the next page of cases from the server, which returns rendered card HTML
 */
